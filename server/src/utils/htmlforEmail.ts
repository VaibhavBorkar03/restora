export const verifyEmailHtml = (verificatoionCode: string) => {
  return `
...
export const ResetLinkMail = (resetUrl: string): string => {
  return `
  <!DOCTYPE html>
  <html>
  <head>
...
export const ResetSuccessEmail = (fullName: string) => {
  return `
  <!DOCTYPE html>
  <html>
  <head>
...
export const WelcomeEmailHtml = (fullName: string): string => {
  return `
  <!DOCTYPE html>
  <html>
  <head>
